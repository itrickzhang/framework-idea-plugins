...
public class NewBasicExeAction extends AnAction {
    ...
    public void actionPerformed(AnActionEvent e) {
        ...
        String str = StringUtils.substringAfter(actionDir, moduleRootPath + "/src/main/resources/");
        //获取右键后的路径
            ...
            protected void run(@NotNull Result result) {
                switch (NewRightContext.getClassType()) {
                    case EdspConstant.COMPONENT_TYPE:
                        createXmlByFtl(project, moduleRootPath,"Component.xml.ftl");
                        break;
                    case EdspConstant.SERVICE_TYPE:
                        createXmlByFtl(project, moduleRootPath,"ServiceType.xml.ftl");
                        break;
                    case EdspConstant.FLOW_TYPE:
                        createXmlByFtl(project, moduleRootPath,"Flow.xml.ftl");
                        break;
                }
                ...
                //优化生成的所有Java类
                EdspIdeaUtils.doOptimize(project);
     ...
     */
    private void createJavaByFtl(Project project, String moduleRootPath, String  ftlName) {
    ...
    private void createXmlByFtl(Project project, String moduleRootPath, String  ftlName) {
        NewRightModel newRightModel= NewRightContext.copyToNewRightModel();
        try {
            PisFileByFreeMarkerUtil.createXmlFile(project, newRightModel, moduleRootPath,ftlName);
            NewRightContext.clearAllSet();
        } catch (Exception ex) {
            ex.printStackTrace();
        }
